...
public class GeneratePDF {
    public static void main(String[] args) {
        try {
            // https://zvezdo.wordpress.com/2014/05/09/java-generate-a-pdf-by-external-library/
            ...
            BaseFont baseFont = BaseFont.createFont("c:/windows/fonts/arialbd.ttf", BaseFont.IDENTITY_H, true);
