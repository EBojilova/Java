...
public class _03_ArrayListExamples {
    ...
    public static void main(String[] args) {
        //List e interface za vsichki vidove listove
       List<String> names = new ArrayList<String>() {{
        ...
        List<ArrayList<ArrayList<Integer>>> numbers = new ArrayList<>();
        addNumbersToTrippleList(numbers);
        System.out.println(numbers);

    }

    static void addNumbersToTrippleList(List<ArrayList<ArrayList<Integer>>> numbers) {
