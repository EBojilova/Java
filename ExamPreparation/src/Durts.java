...
public class Durts {
	...
	public static void main(String[] args) {
		...
		// ne triabva da modificira vhoda, tai kato dava error v judge, primerno int centerX = sc.nextInt()*10;
		int centerX = sc.nextInt();
		int centerY = sc.nextInt();
		int r = sc.nextInt();
		int n = sc.nextInt();

		// double can accept integer value
		double verticalRectMinX = centerX - (0.5 * r);
		double verticalRectMaxX = centerX + (0.5 * r);
		int verticalRectMinY = centerY - r;
		int verticalRectMaxY = centerY + r;
		
		int horizontalRectMinX = centerX - r;
		int horizontalRectMaxX = centerX + r;
